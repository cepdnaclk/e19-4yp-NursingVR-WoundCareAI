...
for clarrifcation. For those cases, you should respond with "NO_MATCH".

All of other scenaios, you should respond with "MATCH". (It's ok if the user ask inappropriate question, 
...
for clarifcations. For those cases, you should respond with "NO_MATCH".

All of other scenaios, you should respond with "MATCH". (It's ok if the student nurse ask inappropriate question, 
